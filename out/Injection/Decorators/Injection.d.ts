 ...
 * }
 */
export declare function Inject(token: Token): (target: object, _propertyKey: string | symbol | undefined, parameterIndex: number) => void;
/**
 ...
 */
export declare function RuntimeParameter(): (target: object, _propertyKey: string | symbol | undefined, parameterIndex: number) => void;
